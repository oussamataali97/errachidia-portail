/**
 * @file
 * Provides UI/UX progressive enhancements on Bootstrap's theme settings by
...
((Drupal, settings, once) => {
  const colorSchemeOptions = settings.bootstrap_sass_starter_kit.colorSchemes;
  ...
  /**
   * Bootstrap Color Picker behavior.
   *
